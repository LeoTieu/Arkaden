        ...
        if usr_answ5.lower() == "w":
            ...
            if usr_answ6.lower() == "y":
                ...
                if usr_answ9.lower() == "y":
                    ...
                    time.sleep(.95)
                    Write.Print("Tanten blir sur och går iväg", Colors.blue_to_green, interval=0.025)
                    break
            ...
            if usr_answ16 == "1":
                ...
                time.sleep(.95)
                Write.Print("\nDu valde att ta en Mars och har betalat 0kr för den", Colors.blue_to_green, interval=0.025)
                time.sleep(.75)
                Write.Print(f"\nDu har nu {wallet.balance}kr", Colors.blue_to_green, interval=0.025)
                break
                ...
                wallet.make_payment(7)
                time.sleep(.95)
                Write.Print("\nDu valde att ta en Twix och har betalat 0kr för den", Colors.blue_to_green, interval=0.025)
                time.sleep(.75)
                Write.Print(f"\nDu har nu {wallet.balance}kr", Colors.blue_to_green, interval=0.025)
                break
                ...
                wallet.make_payment(7)
                time.sleep(.95)
                Write.Print("\nDu valde att ta en Snickers och har betalat 0kr för den", Colors.blue_to_green, interval=0.025)
                time.sleep(.75)
                Write.Print(f"\nDu har nu {wallet.balance}kr", Colors.blue_to_green, interval=0.025)
                break
