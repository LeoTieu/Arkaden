...
class Game:
    def __init__(self, max_points, current_points, price, game, is_locked):
...
Meteorer = Game( 100, 0, "free", meteorer, False)
...
Quiz: {Quiz.current_points} / {Quiz.max_points}
Reaction Game: {Reaction.current_points} / {Reaction.max_points}
Snack: {GetASnack.current_points} / {GetASnack.max_points}
